...
class FlutterInternetSpeedTest {
  ...
  Future<void> startTesting({
    ...
    int fileSizeInBytesDownload = _defaultFileSize,
    int fileSizeInBytesUpload = _defaultFileSize,
    ...
    if (fileSizeInBytesDownload < _defaultFileSize) {
      fileSizeInBytesDownload = _defaultFileSize;
    }
    ...
    FlutterInternetSpeedTestPlatform.instance.startDownloadTesting(
      onDone: (double transferRate, SpeedUnit unit) {
        ...
        FlutterInternetSpeedTestPlatform.instance.startUploadTesting(
          ...
          fileSize: fileSizeInBytesUpload,
      ...
      fileSize: fileSizeInBytesDownload,
